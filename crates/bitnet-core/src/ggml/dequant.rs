...
pub fn tensor_to_f32(data: &[u8], ty: u32, dims: &[u64]) -> Result<Vec<f32>> {
    ...
    match ty {
        ...
        // Type IDs 10 (Q2_K), 11 (Q3_K), 13 (Q5_K), 15 (Q8_K) are standard GGML quantization
        // formats. Routing them to BitNet-specific decoders would silently produce wrong values.
        // Return UnsupportedGgmlType until proper dequantization is implemented.
